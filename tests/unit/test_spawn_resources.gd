...
func test_spawn_phase_defaults():
	...
	assert_eq(phase.period, 0, "默认 period 应为 DAY(0)")
...
func test_spawn_phase_get_enabled_entries_filters():
	...
	# 有效且启用的条目
	var valid_entry = SpawnEntryScript.new()
	...
	var invalid_entry = SpawnEntryScript.new()
