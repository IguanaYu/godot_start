...
func _ready():
	...
	$VBoxContainer/SettingsButton.focus_neighbor_bottom = $VBoxContainer/ExitButton.get_path()
	$VBoxContainer/ExitButton.focus_neighbor_top = $VBoxContainer/SettingsButton.get_path()
